...
mixin _$BaseState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T next) next,
...
class _$NextImpl<T> implements _Next<T> {
  ...
  @override
  String toString() {
    return 'BaseState<$T>.next(next: $next)';
  }
...
abstract class _Next<T> implements BaseState<T> {
  const factory _Next(final T next) = _$NextImpl<T>;
...
abstract class _Success<T> implements BaseState<T> {
  const factory _Success() = _$SuccessImpl<T>;
}
